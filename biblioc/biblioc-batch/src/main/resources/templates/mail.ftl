    ...
    <div class="row">
        <div>
            <div class="box">
                ...
                <p>Bonjour ${prenom}</p>
                <p>
                    Le livre <span style="color: #60a3bc;">${titre}</span> provenant de la bibliotheque <span style="color: #60a3bc;">${bibliotheque}</span>, n'a pas été retourné dans le délais
                    imparti. <br>
                    Vous pouvez le rendre au plus vite dans la bibilothèque soit le déposer dans la boite dédiée au retour devant l'entrée.
                </p>
                <br>
